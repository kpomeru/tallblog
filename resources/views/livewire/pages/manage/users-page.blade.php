<div class="space-y-6 lg:space-y-8">
                    ...
                    <x-slot name="body">
                        ...
                        <x-table.row wire:loading.class.delay="opacity-50" wire:key="row-{{ $user_item->id }}"
                            ...
                            <x-table.cell class="space-x-1 flex items-center">
                                ...
                                <x-heroicon-s-star
                                    class="w-3 {{ $user_item->role === 'super_admin' ? 'text-indigo-500' : 'text-slate-500' }}" />
                                @elseif($user_item->role === 'contributor')
                                <x-heroicon-s-document-text class="w-3 text-slate-500" />
                                @endif
                            </x-table.cell>
    ...
    <livewire:components.users.edit-user />
</div>
